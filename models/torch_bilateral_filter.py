...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        im = cv2.imread('/media/hlemarchant/Data/test/ILSVRC2012_test_0000000' + str(i + 1) + '.JPEG',
        ...
        show_out = cv2.resize(img_out, (500, 500))
        show_in = cv2.resize(img[0, 0].numpy(), (500, 500))
